...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { atk: @monster.atk, def: @monster.def, exp: @monster.exp, hp: @monster.hp, lvl: @monster.lvl, name: @monster.name, type: @monster.type } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { atk: @monster.atk, def: @monster.def, exp: @monster.exp, hp: @monster.hp, lvl: @monster.lvl, name: @monster.name, type: @monster.type } }
