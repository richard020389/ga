...
class MtypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mtype" do
    assert_difference('Mtype.count') do
      post mtypes_url, params: { mtype: { atk: @mtype.atk, def: @mtype.def, exp: @mtype.exp, hp: @mtype.hp, lvl: @mtype.lvl, name: @mtype.name, type: @mtype.type } }
    end
  ...
  test "should update mtype" do
    patch mtype_url(@mtype), params: { mtype: { atk: @mtype.atk, def: @mtype.def, exp: @mtype.exp, hp: @mtype.hp, lvl: @mtype.lvl, name: @mtype.name, type: @mtype.type } }
